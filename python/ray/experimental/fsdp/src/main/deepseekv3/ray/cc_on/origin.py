...
from .....core.deepseekv3.actor import DeepseekActor
from .....core.deepseekv3.model import DEEPSEEKV3_DEBUG as DEEPSEEKV3
...
def init_actors(args: Dict[str, Any]) -> List[DeepseekActor]:
    model_args = DEEPSEEKV3
    ...
    actor_cls = DeepseekActor.options(num_gpus=1)
    actors = [
        actor_cls.remote(
            model_args,
...
def train(
    ...
    metrics = DeepseekActor.get_metrics(tracing)
    log_elapses_to_csv(
        actors_to_elapses,
        output_path,
        latency_prefix,
